...
namespace CineProyecto.Controllers
{
    public class HorarioController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdHorario,Inicio,Fin")] Horario horario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdHorario,Inicio,Fin")] Horario horario)
        {
            if (ModelState.IsValid)
            {
